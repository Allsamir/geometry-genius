...
function createResult (name, value) {  
 ...
 div.innerHTML = `<span>${sum}.${name}</span> <span>${value}</span><span class="cm-value pr-4">cm<sup>2</sup></span><button class="convert bg-buttonBg text-white p-2 rounded-lg cursor-pointer">Convert to m<sup>2</sup></button>`;
